...
void servicesManager::doGetJson(response_ptr response, request_ptr request) {
	...
	res["definitions"]["serviceProcess"]["required"][0]			= "name";
	res["definitions"]["serviceProcess"]["required"][1]			= "status";
	res["definitions"]["serviceProcess"]["required"][1]			= "status";
	...
	res["definitions"]["serviceSocket"]["required"][0]			= "name";
	res["definitions"]["serviceSocket"]["required"][1]			= "status";
	...
	res["definitions"]["serviceLog"]["required"][0]				= "level";
	res["definitions"]["serviceLog"]["required"][1]				= "date_mark";
	res["definitions"]["serviceLog"]["required"][2]				= "line_no";
	res["definitions"]["serviceLog"]["required"][3]				= "timestamp";
	...
	res["definitions"]["services"]["properties"]["process"]["items"]["$ref"]= "#/definitions/serviceProcess";
	res["definitions"]["services"]["properties"]["sockets"]["type"]		= "array";
	res["definitions"]["services"]["properties"]["sockets"]["items"]["$ref"]= "#/definitions/serviceSocket";
	res["definitions"]["services"]["required"][0]				= "sockets";
	res["definitions"]["services"]["required"][1]				= "process";
	res["definitions"]["services"]["required"][2]				= "host";
