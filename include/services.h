...
public:
	...
	void		getJsonCollectorHistory(Json::Value* ref, double since);
...
public:
	...
	bool	haveSocket(uint32_t p_socket_id);
	bool	havePID(uint32_t p_pid);
	void	doGetJson(response_ptr response, request_ptr request, query_args args);
	void	doGetAllJson(response_ptr response, request_ptr request, query_args args);
	void	doGetServiceStatus(response_ptr response, request_ptr request, query_args args);
	void	doGetServiceLog(response_ptr response, request_ptr request, query_args args);
	void	doGetServiceHtml(response_ptr response, request_ptr request, query_args args);
	void	doGetCollectorHistory(response_ptr response, request_ptr request, query_args args);
	void	doGetCollectorGraph(response_ptr response, request_ptr request, query_args args);
	void	doGetRootPage(response_ptr response, request_ptr request, query_args args);
	void	startThreads();
